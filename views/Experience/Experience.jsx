...
import {OrbitControls, Sky, Sparkles, Cloud, Clouds, Stars} from '@react-three/drei'
            ...
            <Canvas camera={{ fov: 65, position: [0, 5, 20] }}>
                <EffectComposer disableNormalPass>
                    ...
                    <>
                        ...
                        <Cloud segments={15} bounds={[1000, 7, 1100]} volume={200} color="white" position={[0, 100, -5]} fade={30} />
                        <Cloud segments={50} bounds={[800, 8, 800]} volume={230} color="white" position={[0, 200, 0]} fade={10} />
                        ...
                        :
                        <Clouds material={THREE.MeshBasicMaterial}>
                            <Cloud segments={50} bounds={[1000, 4, 1000]} volume={100} color="#FCF5E5" position={[0, 100, -4]} fade={60} />
                            <Cloud segments={50} bounds={[800, 8, 800]} volume={250} color="#FCF5E5" position={[0, 200, 0]} fade={30} />
                        </Clouds>
                    }
